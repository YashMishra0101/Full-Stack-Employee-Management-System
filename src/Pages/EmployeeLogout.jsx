...
//     await fetchEmployees(); // Wait for employees data to be fetched

//     if (employeeName && employeeId) {
//       const foundEmployee = employees.find(
//         (item) =>
//           item?.employeeName === employeeName && item?.employeeUniqueid === employeeId
//       );
//       if (foundEmployee) {
//         toast.success("Logout Successful");
//         try {
//           await addDoc(collection(fireDB, "logoutdata"), {
//             action: "logout",
...
//         } catch (error) {
//           console.error("Error adding logout data: ", error);
//           toast.error("Error adding logout data");
//         }
//       } else {
