  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen px-4">
      <div className="container mx-auto ">
        ...
        <div className="flex w-full mt-4 justify-between mb-6">
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pb-10">
          {employees
            ...
            .map((employee) => (
              <div
                key={employee.id}
                className="bg-gray-800 rounded-lg border border-gray-800 p-5 shadow-lg transition hover:border-blue-600 hover:shadow-blue-500 cursor-pointer  hover:shadow-md"
              >
                ...
                <div className="flex justify-between mt-4">
                  ...
                  {/* Modified to redirect to the EditEmployeePage */}
